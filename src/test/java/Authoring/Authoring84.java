...
public class Authoring84 extends TestBase {
	...
	public void beforeTest() throws Exception {
		...
		test = extent
				.startTest(var,
						"Verify that cancel modal is displayed when user clicks on cancel or close ( X button) in a post modal")
	...
	public void testPostCreation() throws Exception {
		...
		try {
			...
			test.log(LogStatus.PASS,
					"Cancel modal is displayed up on clicking X button in post modal");
			} catch (Throwable t) {
				test.log(LogStatus.FAIL,
						"Cancel modal is not displayed up on clicking X button in post modal");
