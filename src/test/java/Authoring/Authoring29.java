...
public class Authoring29 extends TestBase {
	...
	public void beforeTest() throws Exception {
		...
		test = extent.startTest(var, "Verify that user is able to create a post and publish it and verify prevent bot functionality for post creation").assignCategory(
				"Authoring");
