	...
	public void testcaseENW002() throws Exception {
		...
		try {
			...
			try {
				...
				test.log(LogStatus.PASS, " Record sent successfully from Search Results Page");
			}

			catch (Throwable t) {

				test.log(LogStatus.FAIL, " Record is not sent to Endnote from Search Results Page");// extent
																									// reports
				status = 2;// excel
