...
public class Profile46 extends TestBase {
	...
	public void beforeTest() throws Exception {
		...
		test = extent
				.startTest(var,"Verify that profile call to Action(CTA) in a white box is getting  displayed in country field when your first name, last name, title/role, institution, or location/country is blank")
	...
	public void validateProifleCTACountryField() throws Exception {
		try {
			...
			test.log(
					...
					"Snapshot below: "
							+ test.addScreenCapture(captureScreenshot(this.getClass().getSimpleName()
									+ "CTA-country field failed")));// screenshot
			closeBrowser();
		}
	}
