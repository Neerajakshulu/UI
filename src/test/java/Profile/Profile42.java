...
public class Profile42 extends TestBase {
	...
	public void beforeTest() throws Exception {
		...
		test = extent
				.startTest(var,
						"Verify that user is able to edit first name and last name from his own profile page")
	...
	public void validateFirstAndLastName(String firstLastNames) throws Exception {
		try {
			...
			test.log(
					...
					"Snapshot below: "
							+ test.addScreenCapture(captureScreenshot(this.getClass().getSimpleName()
									+ "_first_last_names_not_showing_error_msg")));// screenshot
			closeBrowser();
		}
	}
	...
	public void updateFirstNameAndLastName(String firstName, String lastName) throws Exception {
		try {
			...
			test.log(
					...
					"Snapshot below: "
							+ test.addScreenCapture(captureScreenshot(this.getClass().getSimpleName()
									+ "_first_last_names_not_updated")));// screenshot
			closeBrowser();
		}
	}
