...
public class Profile19 extends TestBase {
	...
	public void beforeTest() throws Exception {
		...
		test = extent.startTest(var, "Verify that user is able to search for profiles with intrests").assignCategory(
				"Profile");
	...
	public void findOthersProfileWithIntersts(String interest) throws Exception {
		try {
			...
			test.log(
					...
					"Snapshot below: "
							+ test.addScreenCapture(captureScreenshot(this.getClass().getSimpleName()
									+ "_unable_to_find_others_profile_with_their_Skills")));
			closeBrowser();
		}
	}
