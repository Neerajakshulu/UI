 ...
 *
 */
public class FindProfileWithCountryTest extends TestBase {
	...
	public void beforeTest() {
		test = extent.startTest(this.getClass().getSimpleName(), "Verify Profile Search with Country").assignCategory("Suite D");
	...
	public void findOthersProfileWithCountry(String country) throws Exception  {
				try {
					...
					status=2;//excel
					test.log(LogStatus.INFO, "Snapshot below: " + test.addScreenCapture(captureScreenshot(this.getClass().getSimpleName()+"_unable_to_find_others_profile_with_their_PrimaryInstitution")));
					closeBrowser();
				}
	}
