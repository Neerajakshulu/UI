...
public class CommentsTabInfiniteScrollValidationTest extends TestBase {
	...
	public void beforeTest() throws Exception {
		...
		test = extent.startTest(var,
				"Verify that Comments tab infinite scroll displaying the more available records").assignCategory("Suite D");
	...
	public void commentTabScrollValidation() throws Exception  {
			try {
				...
				ErrorUtil.addVerificationFailure(t);
				status=2;//excel
				test.log(LogStatus.INFO, "Snapshot below: " + test.addScreenCapture(captureScreenshot(this.getClass().getSimpleName()+"_comment_tab_scroll")));
				closeBrowser();
			}
	}
