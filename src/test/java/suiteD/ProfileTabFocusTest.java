...
public class ProfileTabFocusTest extends TestBase {
	...
	public void beforeTest() throws Exception {
		...
		test = extent.startTest(var,
				"Verify that By default profile tab foucs should be on POST tab").assignCategory("Suite D");
	...
	public void topicTypeaheadValidation() throws Exception  {
			try {
				...
				ErrorUtil.addVerificationFailure(t);
				status=2;//excel
				test.log(LogStatus.INFO, "Snapshot below: " + test.addScreenCapture(captureScreenshot(this.getClass().getSimpleName()+"_post_tab_focus")));
				closeBrowser();
			}
	}
