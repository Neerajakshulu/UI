...
public class CommentsTabTimeStampValidationTest extends TestBase {
	...
	public void beforeTest() throws Exception {
		...
		test = extent.startTest(var,
				"Verify that Comments tab comments displayed with timestamp").assignCategory("Suite D");
	...
	public void commentTabCommentTimestamp() throws Exception  {
			try {
				...
				ProfilePage.commentsTabTimeStamp();
				...
				ErrorUtil.addVerificationFailure(t);
				status=2;//excel
				test.log(LogStatus.INFO, "Snapshot below: " + test.addScreenCapture(captureScreenshot(this.getClass().getSimpleName()+"_comment_tab_timestamp_fail")));
				closeBrowser();
			}
	}
