...
public class FollowingTabInfiniteScrollValidationTest extends TestBase {
	...
	public void beforeTest() throws Exception {
		...
		test = extent.startTest(var,
				"Verify that Following tab infinite scroll displaying the more available records").assignCategory("Suite D");
	...
	public void FollowingTabScrollValidation() throws Exception  {
			try {
				...
				ProfilePage.followingTabScroll();
				...
				ErrorUtil.addVerificationFailure(t);
				status=2;//excel
				test.log(LogStatus.INFO, "Snapshot below: " + test.addScreenCapture(captureScreenshot(this.getClass().getSimpleName()+"_following_tab_scroll")));
				closeBrowser();
			}
	}
