...
public class ENWIAM40 extends TestBase {
	...
	try {
			...
			pf.getLoginTRInstance(ob).enterTRCredentials(CONFIG.getProperty("sru_steamusername"),CONFIG.getProperty("sru_steampwd"));
			...
			//waitForElementTobeVisible(ob, By.xpath(OnePObjectMap.ENDNOTE_HEADER_LOGO_XPATH.toString()), 30);
