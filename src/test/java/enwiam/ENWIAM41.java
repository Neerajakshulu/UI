	...
	public void testcaseh2() throws Exception {
		...
		try {
			...
			try {
				...
				pf.getENWReferencePageInstance(ob).didYouKnow(LOGIN.getProperty("sru_steampwd"));
				...
				boolean continue_button = checkElementIsDisplayed(ob,
						By.cssSelector(OnePObjectMap.ENDNOTE_LOGIN_CONTINUE_BUTTON_CSS.toString()));
