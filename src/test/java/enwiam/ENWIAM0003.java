...
/*
 * Checking Linked STeAM with Facebook account on ENW
 */
...
public class ENWIAM0003 extends TestBase{
	...
	@Test
	public void testcase0003() throws Exception {
	...
	private void loginTofb() throws Exception {
		...
		clearCookies();
         ...
         String passWord="darshiniyogi@123";
        		 String accountType="Facebook";
		// Navigate to TR login page and login with valid TR credentials
		ob.get(host+CONFIG.getProperty("appendENWAppUrl"));
        		 //ob.navigate().to(host);
		
		pf.getENWReferencePageInstance(ob).loginWithENWFBCredentials(userName,passWord);
	...
	//checking linked Facebook with STeAM
