...
public class Search20 extends TestBase {
	...
	public void beforeTest() throws Exception {
		...
		test = extent
				.startTest(var,
						"Verify that user is able to collapse and expand the filters in the left navigation pane in search results page")
	...
	public void testcaseB20() throws Exception {
		...
		try {
			...
			List<WebElement> refineBlocks = ob.findElements(By.xpath(OR
					.getProperty("tr_search_results_refine_blocks_xpath")));
