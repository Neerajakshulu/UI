...
public enum OnePObjectMap {
	...
	COMMON_FEEDBACK_COMMENTS_XPATH("//textarea[@id='msg']"),
	COMMON_FEEDBACK_SUBMIT_BTN_CSS("button[name='hook'][type='submit']"),
	COMMON_FEEDBACK_SENT_CONFIRMATION_CSS("h4[class='ng-binding']"),
	COMMON_FEEDBACK_CLOSE_XPATH("//button[@class='wui-btn wui-btn--primary']"),
	COMMON_ENW_REPORT_PROBLEM_XPATH("//a[@class='feedback-link__anchor']"),
