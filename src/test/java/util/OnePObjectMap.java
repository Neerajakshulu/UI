...
public enum OnePObjectMap {
	...
	WAT_AUTHOR_SEARCH_RESULTS_PAGE_PUBLICATIONS_DETAILS_AUTHOR_AFFILIATION_SUB_ORG_CSS("div[class*='wat-search-results-meta-affiliation ng-binding']+div"),
	WAT_AUTHOR_SEARCH_RESULTS_PAGE_PUBLICATIONS_DETAILS_AUTHOR_AFFILIATION_SUB_ORG_XPATH("(//div[@class='wat-search-results-meta-affiliation ng-binding'])[1]"),
	...
	WAT_AUTHOR_RECORD_PAGE_ALTERNATIVE_NAME_XPATH("//button[@class=\"wat-search__button--add borderless-button ng-scope\"]"),
	WAT_AUTHOR_RECORD_PAGE_ALTERNATIVE_NAME_TAB_HILIGHTED_CSS("li[class='uib-tab nav-item ng-scope ng-isolate-scope']"),
	...
	WAT_AUTHOR_RECORD_PUBLICATIONS_METADATA_METRICS_COUNT1_XPATH("(//div[@class='wui-title ng-binding'])[2]"),
