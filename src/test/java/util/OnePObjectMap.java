...
public enum OnePObjectMap {
	...
	HOME_PROJECT_NEON_PROFILE_PICTURE_BUTTON_CSS("button[ng-click='UserImageEditButtons.update()']"),
	...
	LOGIN_PAGE_SIGN_IN_BUTTON_CSS("button[class='wui-btn login-button button-color-primary wui-btn--primary']"),
