...
public enum OnePObjectMap {
	...
	//Added by Chhinna on 8th Nov 2016
	...
	// #######RCC#############
		...
		RCC_GROUPSLIST_GROUP_TITLE_LINK_CSS("a[class='research-group-card__text']"),
		...
		RCC_GROUPSLIST_GROUP_DESCRIPTION_CSS("a[class='research-group-card__text'] p"),		RCC_GROUP_GROUPS_LINK__CSS("span[class='wui-title'] a"),
