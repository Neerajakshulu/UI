...
public enum OnePObjectMap {
	...
	ENW_CONTINUE_BUTTON("//div[@id='continue']"),
	ENW_CONTINUE_DIOLOG_BOX("//div[@id='noticeDialog']"),
	ENW_Header_XPATH(".//*[@id='enwHeader']/div[1]/div/div/h1"),
	ENW_Profile_User_Icon_XPATH(".//*[@id='proSmallImg']"),
	ENW_Profile_User_Name_XPATH(".//*[@id='profile']/li[1]/a/p/span[1]"),
	Image_User_XPATH(".//*[@id='proImg']"),
	ENW_Privacy_Link_XPATH(".//*[@id='profile']/li[2]/ul[2]/li[1]/a"),
	ENW_terms_of_use_XPATH(".//*[@id='profile']/li[2]/ul[2]/li[3]/a"),
	ENW_help_XPATH(".//*[@id='profile']/li[2]/ul[2]/li[5]/a"),
	ENW_Feedback_XPATH(".//*[@id='profile']/li[2]/ul[2]/li[7]/a"),
	ENW_Options_Tab_XPATH("//*[@id='lgLink6']"),
	ENW_Profile_Tab_XPATH("//*[@id='submenu_6']/li[3]/a"),
	ENW_Profile_First_name_XPATH("//*[@id='firstname']"),
	ENW_Profile_Last_name_XPATH("//*[@id='lastname']"),
	ENW_SignIn_BTN_CSS("button[class*='login-button']"),

	COMMON_SEND_fEEDBACK_ENDNOTE_TEAM("//a[@class='feedback-link__anchor ng-binding']"),
	COMMON_FEEDBACK_COMMENTS(".//*[@id='msg']"),
	COMMON_FEEDBACK_SUBMIT_BTN(".//*[@id='hookform']/div[2]/button[2]"),
	COMMON_FeedBack_sent_confirmation("//*[@class('ng-binding' and contains(text(),'Your feedback has been sent')]"),
	COMMON_FEEDBACK_CLOSE("//*[@class('wui-btn wui-btn--primary' and contains(text(),'Close')]"),
	COMMON_ENW_REPORT_PROBLEM("//a[@class('feedback-link__anchor']"),
	EXPECTED_PAGE_DISPLAYED(".//*[@id('header']/h1/a[1]"),
	EXPECTED_PAGE_DISPLAYED1("html/body/div[6]/div/div/div[1]/h3"),
	...
	WATCHLIST_WATCH_BUTTON_IN_SEACHPAGE_CSS("button[class='wui-icon-btn wui-icon-btn--horizontal-spacing dropdown-toggle']"),
	...
	RCC_GROUPDETAILS_LINKED_ITEMS_COUNT_CSS(""),
	RCC_GROUPDETAILS_MEMBERS_COUNT_CSS(""),
	RCC_GROUPSDETAILS_DELETE_GROUP_BUTTON_CSS(""),
	RCC_GROUPSDETAILS_EDIT_GROUP_BUTTON_CSS(""),
	RCC_GROUPSDETAILS_LINK_ITEMS_BUTTON_CSS(""),
	RCC_GROUPSDETAILS_INVITE_OTHERS_BUTTON_CSS(""),
	RCC_GROUPDETAILS_MEMBERS_TAB_CSS(""),
	...
	RCC_GROUPDETAILS_GROUP_TITLE_CSS(""),
	RCC_GROUPDETAILS_INVITE_MEMBER_TYPE_AHEAD_CSS(""),
	RCC_GROUPDETAILS_INVITE_MEMBER_TYPE_AHEAD_OPTIONS_CSS(""),
	RCC_GROUPDETAILS_INVITE_MEMBERS_SEND_BUTTON_CSS(""),
	RCC_GROUPDETAILS_INVITE_MEMBERS_CANCEL_BUTTON_CSS(""),
	RCC_GROUPINVITATIONS_INVITATION_CARD_CSS(""),
	RCC_GROUPINVITATIONS_ACCEPT_INVITAION_BUTTON_CSS(""),
	RCC_GROUPINVITATIONS_INVITATION_CARD_TITLE_CSS(""),
	RCC_GROUPINVITATIONS_DECLINE_INVITAION_BUTTON_CSS(""),
