...
public enum OnePObjectMap {
	...
	HOME_PROJECT_NEON_SEARCH_CLICK_CSS("i[class='fa fa-search']"),

	HOME_PROJECT_NEON_SEARCH_PEOPLE_CSS("li[class='wui-side-menu__list-item ng-scope']"),
	...
	HOME_PROJECT_NEON_PROFILE_ROLE_METADATA_CSS("span[ng-if='vm.user.role']"),
	HOME_PROJECT_NEON_PROFILE_PRIMARYINSTITUTION_METADATA_CSS("span[ng-if='vm.user.primaryInstitution']"),
	HOME_PROJECT_NEON_PROFILE_LOCATION_METADATA_CSS("span[ng-if='vm.user.location']"),
