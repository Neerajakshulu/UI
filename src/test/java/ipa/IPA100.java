...
public class IPA100 extends TestBase {
	...
	public void beforeTest() throws Exception {
		...
		test = extent.startTest(tests[0], tests_dec[0]).assignCategory("IPA");
	...
	public void testcaseIPA0010() throws Exception {
		...
		if (!master_condition) {
			...
			for (int i = 0; i < tests.length; i++) {
				...
				test = extent.startTest(tests[i], tests_dec[i]).assignCategory("IPA");
