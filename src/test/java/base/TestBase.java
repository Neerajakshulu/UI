...
public class TestBase {
	...
	/*
	 * public void openBrowser() throws Exception { DesiredCapabilities desiredCapabilities = new DesiredCapabilities();
	 * desiredCapabilities.setBrowserName(System.getenv("SELENIUM_BROWSER"));
	 * System.out.println("Selenium Browser Name-->" + System.getenv("SELENIUM_BROWSER"));
	 * desiredCapabilities.setVersion(System.getenv("SELENIUM_VERSION")); System.out.println("Selenium Version-->" +
	 * System.getenv("SELENIUM_VERSION")); System.out.println("Selenium Plaform-->" +
	 * System.getenv("SELENIUM_PLATFORM")); desiredCapabilities.setCapability(CapabilityType.PLATFORM,
	 * System.getenv("SELENIUM_PLATFORM")); desiredCapabilities.setCapability(CapabilityType.ACCEPT_SSL_CERTS, true); //
	 * desiredCapabilities.setCapability(CapabilityType.HAS_NATIVE_EVENTS, true); ob = new RemoteWebDriver( new
	 * URL("http://amneetsingh:f48a9e78-a431-4779-9592-1b49b6d406a4@ondemand.saucelabs.com:80/wd/hub"),
	 * desiredCapabilities); String waitTime = CONFIG.getProperty("defaultImplicitWait"); String pageWait =
	 * CONFIG.getProperty("defaultPageWait"); ob.manage().timeouts().implicitlyWait(Long.parseLong(waitTime),
	 * TimeUnit.SECONDS); try { ob.manage().timeouts().implicitlyWait(Long.parseLong(pageWait), TimeUnit.SECONDS); }
	 * catch (Throwable t) { System.out.println("Page Load Timeout not supported in safari driver"); } }
	 */
