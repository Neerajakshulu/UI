...
/**
 * Class to Verify the consistent presence of LOGO at the top left of page.
 * 
 * 
 * @author UC202376
 *
 */
public class WAT44 extends TestBase {
	...
	/**
	 * Method for login into WAT application using TR ID and Verify the
	 * consistent presence of LOGO at the top left of page.
	 * 
	 * 
	 * @throws Exception,
	...
	public void testCALogo(String username, String password) throws Exception {
		...
		try {
			...
			test.log(LogStatus.PASS, "Clarivate Analytics LOGO displayed");
