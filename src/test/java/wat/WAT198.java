...
/**
 * Class to Verify that undo option for publication in Author record page should
 * not be available in non curation mode
 * 
 * @author UC225218
 *
 */
public class WAT198 extends TestBase {
	...
	/**
	 * Method to Verify that undo option for publication in Author record page
	 * should not be available in non curation mode
	 * 
	 * @param LastName,
	...
	public void testCurationPublicationUndo() throws Exception {
		try {
			...
			if (pf.getBrowserActionInstance(ob)
					.getElement(OnePObjectMap.WAT_AUTHOR_RECORD_PUBLICATION_UNDO_LINK_XPATH).isDisplayed())
				throw new Exception(
