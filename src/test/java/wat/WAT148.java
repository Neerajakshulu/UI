...
/**
 * Class to Verify that for a Single author the "Total Citing Publications"
 * value will be less than or equal to the "Total Citations" value.
 * 
 * @author UC225218
 *
 */
public class WAT148 extends TestBase {
	...
	/**
	 * Method to Verify that for a Single author the "Total Citing
