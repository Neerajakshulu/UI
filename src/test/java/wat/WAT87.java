...
/**
 * Class for Verify that when user gets into Author search page there will be no (-) symbol present
 * 
 * @author UC225218
 *
 */
public class WAT87 extends TestBase {
	...
	/**
	 * Method to Verify that when user gets into Author search page there will be no (-) symbol present
	 * 
	 * 
	 * @throws Exception,
	 *             When Something unexpected
	...
	public void testRemoneAltNameBtnTest()
			throws Exception {
