...
/**
 * Class to Verify that on the Single Author Record page, in the Single
 * Author Metadata panel, the system should display a "Total Citing
 * Publications" metric.
 * 
 * @author UC225218
 *
 */
public class WAT149 extends TestBase {
	...
	/**
	 * Method to Verify that on the Single Author Record page, in the Single
	 * Author Metadata panel, the system should display a "Total Citing
	 * Publications" metric.
	 * 
	 * @throws Exception,
	...
	public void testMetric() throws Exception {
		try {
			...
			test.log(LogStatus.PASS, "Citing Articles metrics is displayed and text is present as expected");
			pf.getBrowserActionInstance(ob).closeBrowser();
		} catch (Throwable t) {
			logFailureDetails(test, t, "Metrics in Single author page is not displayed as expected",
