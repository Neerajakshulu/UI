 ...
 * content of Last Name field is removed.
 * 
 * 
 * @author UC225218
 *
 */
public class WAT20 extends TestBase {
	...
	/**
	 * Method to Verify that "Add alternative name" button should be (Gryed out)
	 * when content of Last Name field is removed.
	 * 
	 * @throws Exception,
	 *             When Something unexpected
	 * @param LastName
