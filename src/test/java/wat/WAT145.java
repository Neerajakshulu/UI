...
/**
 * Class to Verify that on the Combined Author Record page, in the Combined
 ...
 *
 */
public class WAT145 extends TestBase {
	...
	/**
	 * Method to Verify that on the Combined Author Record page, in the Combined
	 * Author Metadata panel, the system should display a "Total Citing
	 * Publications" metric.
	 * 
	 * @throws Exception,
