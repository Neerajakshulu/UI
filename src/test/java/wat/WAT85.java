...
/**
 * Class for Verifying that Symbol (-) works for only LN
 * 
 * @author UC225218
 *
 */
public class WAT85 extends TestBase {
	...
	/**
	 * Method to Verify that Symbol (-) works for only LN
	 * 
	 * @param LastName
	 * @throws Exception,
	 *             When Something unexpected
	...
	@Parameters({ "LastName"})
	public void testRemoneAltNameOnlyLN(String LastName)
			throws Exception {
