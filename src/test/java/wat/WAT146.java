...
/**
 * Class to Verify that the metrics should carry labels spelled/worded exactly as listed.
 * 
 * @author UC225218
 *
 */
public class WAT146 extends TestBase {
	...
	/**
	 * Method to Verify that the metrics should carry labels spelled/worded exactly as listed.
	 * 
	 * @throws Exception,
	 *             When Something unexpected
	 */
