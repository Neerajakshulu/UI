...
/**
 * Class to Verify that User must be able to deselect records.
 * 
 * @author UC225218
 *
 */
public class WAT74 extends TestBase {
	...
	/**
	 * Method to Verify that User must be able to deselect records.
	 * 
	 * @param orcid
	 * @throws Exception, When Something unexpected
	 */
	...
	public void VerifyDeSelectallcardl(String LastName, String CountryName1,String CountryName2,
