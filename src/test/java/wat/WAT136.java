 ...
 * are also displayed."Suggest updates" is hidden.
 * 
 * @author UC225218
 *
 */
public class WAT136 extends TestBase {
	 ...
	 * pubs options are also displayed."Suggest updates" is hidden.
	 * 
	 * @param LastName,
	...
	public void testCurationModeRejectRecmndtn() throws Exception {
		try {
			...
			test.log(LogStatus.INFO, "Getting into curation mode by clicking Reject recommendation button");
			pf.getAuthorRecordPage(ob).getintoCuration(test, "RejectRecommendation");
			pf.getBrowserActionInstance(ob).closeBrowser();
		} catch (Throwable t) {
