...
/**
 * Class to Verify that when user clicks on deselect all link, system must deselect all records.
 * 
 * @author UC225218
 *
 */
public class WAT78 extends TestBase {
	...
	/**
	 * Method to Verify that when user clicks on deselect all link, system must deselect all records.
	 *  
	 * @param orcid
	 * @throws Exception, When Something unexpected
	 */
	...
	public void VerifyDeSelectAllFunctionality(String LastName, String CountryName1,String CountryName2,
