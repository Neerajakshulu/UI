...
/**
 * Class to Verify that user should not be able to submit feedback without
 * entering curation mode
 * 
 * @author UC225218
 *
 */
public class WAT193 extends TestBase {
	...
	/**
	 * Method to Verify that user should not be able to submit feedback without
	 * entering curation mode
	 * 
	 * @param LastName,
	...
	public void testCurationModeNegativeScenario() throws Exception {
		try {
			...
			logFailureDetails(test, t, "Able to submit a feedback without entering curation", "Curation_issue");
			pf.getBrowserActionInstance(ob).closeBrowser();
		}
