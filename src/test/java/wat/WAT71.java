...
/**
 * Class to Verify that until a minimum of 2 records are selected in author search results page, the Combine button should be disabled.
 * 
 * @author UC225218
 *
 */
public class WAT71 extends TestBase {
	...
	/**
	 * Method to Verify that until a minimum of 2 records are selected in author search results page, the Combine button should be disabled.
	 * 
	 * @param orcid
	 * @throws Exception, When Something unexpected
	 */
	...
	public void CombineButtonminimumReq(String LastName, String CountryName1,String CountryName2,
