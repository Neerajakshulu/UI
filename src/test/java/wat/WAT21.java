 ...
 * by User then correct error message should be displayed. - Last name
 * 
 * @author UC225218
 *
 */
public class WAT21 extends TestBase {
	 ...
	 * entered by User then correct error message should be displayed. - Last
	 * name
	 * 
	 * @throws Exception,
	 *             When Something unexpected
	...
	public void testClientSideValidationLastName() throws Exception {
