 ...
 * the author record at a time(For Single Author) individual pubs options are
 * also displayed."Suggest updates" is hidden.
 * 
 * @author UC225218
 *
 */
public class WAT190 extends TestBase {
	 ...
	 * on the author record at a time(For Single Author)
	 * @param LastName,
	...
	public void testRecommendationCountSingleAuthor() throws Exception {
		try {
