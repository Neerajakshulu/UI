...
/**
 * Class to "Verify that for a single author The left-to-right order of the
 ...
 *
 */
public class WAT147 extends TestBase {
	...
	/**
	 * Method to "Verify that for a single author The left-to-right order of the
	 * metrics in the Author Metadata area of the Author Record should be:
	...
	public void testMetricsForSingleAuthor() throws Exception {
		try {
