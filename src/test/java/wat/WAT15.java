 ...
 * characters in First Name. This is a negative scenario.
 * 
 * @author UC225218
 *
 */
public class WAT15 extends TestBase {
	...
	@Parameters({ "LastName" })
	public void testSearchAuthorClusterAlphanuemricFirstName(String LastName) throws Exception {

		try {
			pf.getSearchAuthClusterPage(ob).searchAuthorClusterAlphanuemricFirstName(LastName, test);
