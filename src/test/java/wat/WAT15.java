...
public class WAT15 extends TestBase {
	...
	@Parameters({ "LastName" })
	public void testSearchAuthorClusterWithOnlyFirstName(String LastName) throws Exception {
		...
		try {
			...
			if (ele.size() != 0 && !pf.getBrowserActionInstance(ob)
				...
				test.log(LogStatus.PASS,
						"Unable to search for author cluster with alphanumeric characters in First name");
			} else {
