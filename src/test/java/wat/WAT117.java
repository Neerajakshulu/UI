...
/**
 * Class for Verify that User should be able to ignore Country dropdown and proceed with author search
 * 
 * @author UC225218
 *
 */

public class WAT117 extends TestBase {
	...
	/**
	 * Method to Verify that User should be able to ignore Country dropdown and proceed with author search
	 * 
	 * @throws Exception,
	 *             When Something unexpected
	 * 
	...
	public void testFindButtonFunctionality2(String LastName, String CountryName1,String CountryName2, String OrgName1,String OrgName2)
			throws Exception {
			try {
				pf.getSearchAuthClusterPage(ob).testFindButtonFunctionality2(LastName,test);
			} catch (Throwable t) {
