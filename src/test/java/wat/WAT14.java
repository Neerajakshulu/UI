...
/**
 * Class for testing Author cluster search functionality with numbers in First
 * Name. This is a negative scenario.
 * 
 * @author UC225218
 *
 */
public class WAT14 extends TestBase {
	...
	@Parameters({ "LastName" })
	public void testSearchAuthorClusterNumberFirstName(String LastName) throws Exception {

		try {
			pf.getSearchAuthClusterPage(ob).searchAuthorClusterNumberFirstName(LastName, test);
