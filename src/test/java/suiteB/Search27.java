...
//      3--->SKIP
	...
	public void beforeTest() throws Exception{
		...
		test = extent.startTest(var, "Verify that 4 suggested categories get displayed in type ahead and the typed keyword is present in all the 4 categories").assignCategory("Search suite");
