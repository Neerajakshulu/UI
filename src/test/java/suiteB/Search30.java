...
//      3--->SKIP;
	...
	public void beforeTest() throws Exception{ extent = ExtentManager.getReporter(filePath);
		...
		test = extent.startTest(var, "Verify that 4 suggested people get displayed in type ahead and the typed keyword is present in all the 4 people").assignCategory("Search suite");
