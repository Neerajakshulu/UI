...
public class TestCase_B4 extends TestBase{
	static int status=1;
...
//      3--->SKIP
	...
	public void beforeTest(){
		...
		test = extent.startTest(this.getClass().getSimpleName(), "To verify that NESTING WITH PARENTHESIS rule is working correctly").assignCategory("Suite B");
