...
public class TestCase_B29 extends TestBase{
	static int status=1;
...
//      3--->SKIP
	...
	public void beforeTest() throws Exception{
		...
		test = extent.startTest(var, "Verify that 4 suggested patents get displayed in type ahead and the typed keyword is present in all the 4 patents").assignCategory("Suite B");
