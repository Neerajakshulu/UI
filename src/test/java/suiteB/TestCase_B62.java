...
public class TestCase_B62 extends TestBase {
	static int status = 1;
...
//			ob.navigate().to(CONFIG.getProperty("testSiteName"));
			...
			if(!compareNumbers(10,al.size())){
				...
				test.log(LogStatus.FAIL, "More or less than 10 people suggestions are getting displayed");//extent reports
				status=2;//excel
				test.log(LogStatus.INFO, "Snapshot below: " + test.addScreenCapture(captureScreenshot(this.getClass().getSimpleName()+"_more_or_less_than_ten_people_suggestions_getting_displayed")));//screenshot
			}
