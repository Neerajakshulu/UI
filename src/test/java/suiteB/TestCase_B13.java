...
public class TestCase_B13 extends TestBase{
	static int status=1;
...
//      3--->SKIP
	...
	public void beforeTest(){
		...
		test = extent.startTest(this.getClass().getSimpleName(), "To verify that NOT is not treated as a boolean").assignCategory("Suite B");
