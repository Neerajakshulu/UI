...
public class TestCase_B63 extends TestBase {
	static int status = 1;
...
//			ob.navigate().to(CONFIG.getProperty("testSiteName"));
			...
			if(!compareStrings(expected_text1,actual_text1)){
				...
				status=2;//excel
				test.log(LogStatus.INFO, "Snapshot below: " + test.addScreenCapture(captureScreenshot(this.getClass().getSimpleName()+"_proper_message_not_getting_displayed_for_ALL_option")));//screenshot
			...
			if(!compareStrings(expected_text2,actual_text2)){
				...
				status=2;//excel
				test.log(LogStatus.INFO, "Snapshot below: " + test.addScreenCapture(captureScreenshot(this.getClass().getSimpleName()+"_proper_message_not_getting_displayed_for_ARTICLES_option")));//screenshot
			...
			if(!compareStrings(expected_text3,actual_text3)){
				...
				status=2;//excel
				test.log(LogStatus.INFO, "Snapshot below: " + test.addScreenCapture(captureScreenshot(this.getClass().getSimpleName()+"_proper_message_not_getting_displayed_for_PATENTS_option")));//screenshot
			...
			if(!compareStrings(expected_text4,actual_text4)){
				...
				status=2;//excel
				test.log(LogStatus.INFO, "Snapshot below: " + test.addScreenCapture(captureScreenshot(this.getClass().getSimpleName()+"_proper_message_not_getting_displayed_for_PEOPLE_option")));//screenshot
			...
			if(!compareStrings(expected_text5,actual_text5)){
				...
				status=2;//excel
				test.log(LogStatus.INFO, "Snapshot below: " + test.addScreenCapture(captureScreenshot(this.getClass().getSimpleName()+"_proper_message_not_getting_displayed_for_POSTS_option")));//screenshot
...
//			System.out.println(tile5);
			...
			try{
				...
				test.log(LogStatus.PASS, "Result count getting displayed correctly in the left navigation pane for all the content types when search query is not properly interpreted by the system");// extent report
			}
			
			catch(Throwable t){
				
				test.log(LogStatus.FAIL, "Result count not getting displayed correctly in the left navigation pane for all the content types when search query is not properly interpreted by the system");// extent report

            	ErrorUtil.addVerificationFailure(t);// testng
            	status = 2;// excel
            	test.log(LogStatus.INFO, "Snapshot below: " + test.addScreenCapture(
            			captureScreenshot(this.getClass().getSimpleName() + "_result_count_not_getting_displayed_correctly_in_the_left_navigation_pane")));// screenshot
