...
//      3--->SKIP
	...
	public void beforeTest() throws Exception{ extent = ExtentManager.getReporter(filePath);
		...
		test = extent.startTest(var, "Verify the changes taking place when user clicks on any CATEGORIES option in the search type ahead while ALL option is selected in the search drop down").assignCategory("Search suite");
