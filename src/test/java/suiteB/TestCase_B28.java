...
public class TestCase_B28 extends TestBase{
	static int status=1;
...
//      3--->SKIP
	...
	public void beforeTest() throws Exception{
		...
		test = extent.startTest(var, "Verify that 4 suggested articles get displayed in type ahead and the typed keyword is present in all the 4 articles").assignCategory("Suite B");
...
//			}
			...
			if(!compareNumbers(4,al.size())){
				...
				status=2;//excel
				test.log(LogStatus.INFO, "Snapshot below: " + test.addScreenCapture(captureScreenshot(this.getClass().getSimpleName()+"_moreor_less_than_four_article_suggestions_getting_displayed")));//screenshot
			}
