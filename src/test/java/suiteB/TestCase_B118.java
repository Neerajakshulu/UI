...
public class TestCase_B118 extends TestBase{
	static int status=1;
...
//      3--->SKIP
	...
	public void beforeTest() throws Exception{
		...
		test = extent.startTest(var, "Verify that following things are retained when user navigates back to PATENTS search results page from record view page:"+""
				+ "a)Sorting b)Left navigation pane content type c)Search drop down content type d)Filtering").assignCategory("Suite B");
