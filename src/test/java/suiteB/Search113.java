...
//      3--->SKIP
	...
	public void beforeTest113() throws Exception{
		...
		test = extent.startTest(var, "Verify that MORE and LESS links are working correctly in INVENTOR filter in PATENTS search results page").assignCategory("Search suite");
