...
//      3--->SKIP
	...
	public void beforeTest(){
		...
		test = extent.startTest(this.getClass().getSimpleName(), "To verify that * is treated as a space if user does not provide 3 characters before it").assignCategory("Suite B");
