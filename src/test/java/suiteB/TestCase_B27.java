...
public class TestCase_B27 extends TestBase{
	static int status=1;
...
//      3--->SKIP
	...
	public void beforeTest() throws Exception{
		...
		test = extent.startTest(var, "Verify that 4 suggested categories get displayed in type ahead and the typed keyword is present in all the 4 categories").assignCategory("Suite B");
