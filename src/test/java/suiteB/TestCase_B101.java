...
public class TestCase_B101 extends TestBase {
static int status=1;
...
//      3--->SKIP
	...
	public void beforeTest() throws Exception{
		...
		test = extent.startTest(var, "Verify that sorting is retained when user navigates back to PATENTS search results page from record view page").assignCategory("Suite B");
