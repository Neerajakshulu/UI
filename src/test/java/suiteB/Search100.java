...
//      3--->SKIP
	...
	public void beforeTest() throws Exception{
		...
		test = extent.startTest(var, "Verify that more search results get displayed when user scrolls down in PATENTS search results page").assignCategory("Search suite");
