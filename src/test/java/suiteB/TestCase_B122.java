...
public class TestCase_B122 extends TestBase {
	static int status=1;
	...
	public void beforeTest() throws Exception{
		...
		test = extent.startTest(var, "Verify that left navigation pane content type is retained when user navigates back to PEOPLE search results page from record view page").assignCategory("Suite B");
