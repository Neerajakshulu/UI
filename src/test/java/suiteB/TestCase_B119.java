...
public class TestCase_B119 extends TestBase {
	static int status = 1;
...
//			System.out.println("al2 size="+al2.size());
			...
			try{
				...
				test.log(LogStatus.FAIL, "Sorting is not retained when user navigates back to ALL search results page from record view page");// extent
...
//			System.out.println("Text1="+text1);
			...
			if(!compareStrings("Patents",text1)){
				...
				test.log(LogStatus.FAIL, "Search drop down option not retained when user navigates back to ALL search results page from record view page");//extent reports
				status=2;//excel
