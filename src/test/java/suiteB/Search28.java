...
//      3--->SKIP
	...
	public void beforeTest() throws Exception{
		...
		test = extent.startTest(var, "Verify that 4 suggested articles get displayed in type ahead and the typed keyword is present in all the 4 articles").assignCategory("Search suite");
