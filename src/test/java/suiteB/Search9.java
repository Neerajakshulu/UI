...
//      3--->SKIP
	...
	public void beforeTest() throws Exception{ extent = ExtentManager.getReporter(filePath);
		...
		test = extent.startTest(var, "Verify that sorting is retained when user navigates back to search results page from record view page").assignCategory("Search suite");
