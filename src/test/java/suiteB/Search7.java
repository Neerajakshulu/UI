...
//      3--->SKIP
	...
	public void beforeTest() throws Exception{ extent = ExtentManager.getReporter(filePath);
		...
		test = extent.startTest(var, "Verify that no search results get displayed if search engine doesn't interpret the query and that a proper message gets displayed regarding that").assignCategory("Search suite");
