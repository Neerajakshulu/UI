...
public class TestCase_B14 extends TestBase{
	static int status=1;
...
//      3--->SKIP
	...
	public void beforeTest(){
		...
		test = extent.startTest(this.getClass().getSimpleName(), "To verify that AND is not treated as a boolean").assignCategory("Suite B");
