...
//      3--->SKIP
	...
	public void beforeTest() throws Exception{
		...
		test = extent.startTest(var, "Verify that user is able to collapse and expand the filters in the left navigation pane in search results page").assignCategory("Search suite");
