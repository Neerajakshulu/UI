...
//      3--->SKIP
	...
	public void beforeTest() throws Exception{
		...
		test = extent.startTest(var, "Verify that following sections get displayed in type ahead:a)Categoriesb)Articlesc)Patentsd)People").assignCategory("Search suite");
