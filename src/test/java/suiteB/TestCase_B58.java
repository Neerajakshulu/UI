...
public class TestCase_B58 extends TestBase {
	static int status = 1;
...
//			ob.navigate().to(CONFIG.getProperty("testSiteName"));
			...
			try{
				...
				test.log(LogStatus.PASS, "Autocompleted keyword coming up and it contains the searched keyword");// extent report
			}
			
			catch(Throwable t){
				
				test.log(LogStatus.FAIL, "Autocompleted keyword doesn't contain the searched keyword");// extent report

            	ErrorUtil.addVerificationFailure(t);// testng
            	status = 2;// excel
            	test.log(LogStatus.INFO, "Snapshot below: " + test.addScreenCapture(
            			captureScreenshot(this.getClass().getSimpleName() + "_autocompleted_keyword_does_not_contain_searched_keyword")));// screenshot
...
//			}
			...
			if(!compareNumbers(4,al1.size())){
				...
				test.log(LogStatus.FAIL, "More or less than 4 category suggestions are getting displayed");//extent reports
				status=2;//excel
				test.log(LogStatus.INFO, "Snapshot below: " + test.addScreenCapture(captureScreenshot(this.getClass().getSimpleName()+"_more_or_less_than_four_category_suggestions_getting_displayed")));//screenshot
			}
			...
			if(!compareNumbers(0,count1)){
				...
				test.log(LogStatus.FAIL, "Category suggestion does not contain the typed keyword");//extent reports
				status=2;//excel
				test.log(LogStatus.INFO, "Snapshot below: " + test.addScreenCapture(captureScreenshot(this.getClass().getSimpleName()+"_category_suggestion_does_not_contain_typed_keyword")));//screenshot
			}
			...
			if(!compareNumbers(4,al2.size())){
				...
				status=2;//excel
				test.log(LogStatus.INFO, "Snapshot below: " + test.addScreenCapture(captureScreenshot(this.getClass().getSimpleName()+"_more_or_less_than_four_article_suggestions_getting_displayed")));//screenshot
			}
			...
			if(!compareNumbers(4,al3.size())){
				...
				test.log(LogStatus.FAIL, "More or less than 4 patent suggestions are getting displayed");//extent reports
				status=2;//excel
				test.log(LogStatus.INFO, "Snapshot below: " + test.addScreenCapture(captureScreenshot(this.getClass().getSimpleName()+"_more_or_less_than_four_patent_suggestions_getting_displayed")));//screenshot
			}
			...
			if(!compareNumbers(4,al5.size())){
				...
				test.log(LogStatus.FAIL, "More or less than 4 post suggestions are getting displayed");//extent reports
				status=2;//excel
				test.log(LogStatus.INFO, "Snapshot below: " + test.addScreenCapture(captureScreenshot(this.getClass().getSimpleName()+"_more_or_less_than_four_post_suggestions_getting_displayed")));//screenshot
			}
