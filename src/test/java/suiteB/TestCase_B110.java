...
public class TestCase_B110 extends TestBase {
...
//			System.out.println(mylist);
			...
			try{
				...
				test.log(LogStatus.FAIL, "Patents are not sorted correctly as per TIMES CITED field in PATENTS content type");// extent reports
				ErrorUtil.addVerificationFailure(t);// testng
				status = 2;// excel
				test.log(LogStatus.INFO, "Snapshot below: " + test.addScreenCapture(
						captureScreenshot(this.getClass().getSimpleName() + "_incorrect_TIMES_CITED_sorting_in_PATENTS_content_type")));// screenshot
