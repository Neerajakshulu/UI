...
//      3--->SKIP
	...
	public void beforeTest() throws Exception{ extent = ExtentManager.getReporter(filePath);
		...
		test = extent.startTest(var, "Verify that following options get displayed in SORT BY drop down in ALL search results page:a)Relevanceb)Times Citedc)Date").assignCategory("Search suite");
