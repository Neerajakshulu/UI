...
public class AppreciateUnAppreciateOwnPost extends TestBase{
	...
	public void beforeTest() throws Exception {
		...
		test = extent.startTest(var, "Verify that user is able to Appreciate/Un Appreciate their own post")
	...
	public void testPostAppreciation() throws Exception {
		...
		try {
			...
			boolean result1=PostRecordViewPage.validateLikeAndUnlikePostActions();
			boolean result2=PostRecordViewPage.validateLikeAndUnlikePostActions();
			if(!result1 || !result2){
				status=2;
			}
