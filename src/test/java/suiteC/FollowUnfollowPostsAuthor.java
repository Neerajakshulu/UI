...
public class FollowUnfollowPostsAuthor extends TestBase{
	...
	public void beforeTest() throws Exception {
		...
		test = extent.startTest(var, "Veirfy that the user is able to follow the author of the post directly from the post.")
	...
	public void testPostAppreciation() throws Exception {
		...
		try {
			...
			try {
				Assert.assertTrue(PostRecordViewPage.IsFollowOrUnfollowButtonDispayed());
				test.log(LogStatus.PASS, "Follow/Unfollow button is displayed in view post record page");
				PostRecordViewPage.validateFollowOrUnfollow();
				PostRecordViewPage.validateFollowOrUnfollow();
