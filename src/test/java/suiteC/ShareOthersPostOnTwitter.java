...
public class ShareOthersPostOnTwitter extends TestBase{
	...
	public void beforeTest() throws Exception{ extent = ExtentManager.getReporter(filePath);
		...
		test = extent.startTest(var, "Verify that user is able to share the posts of others in twitter.")
				.assignCategory("Suite C");

	}

	@Test@Parameters({"tusername","tpassword"})
	public void testPostComments(String tusername,String tpassword) throws Exception {
