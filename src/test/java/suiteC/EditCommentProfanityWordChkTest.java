...
public class EditCommentProfanityWordChkTest extends TestBase{
	...
	public void beforeTest() throws Exception {
		...
		test = extent
				.startTest(var,
						"Verify that profanity words are not allowed while editing the comments.").assignCategory("Suite C");
