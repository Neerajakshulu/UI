...
public class MinMaxLenValidationPostContent extends TestBase{
	...
	public void beforeTest() throws Exception {
		...
		test = extent.startTest(var, "CREATE POST:Verfiy that proper error messages are displyed for min max length validation of POST CONTENT")
