...
public class ShareOthersPostInFB extends TestBase{
	...
	public void beforeTest() throws Exception{ extent = ExtentManager.getReporter(filePath);
		...
		test = extent.startTest(var, "Verify that user is able to share the post created by others via FB")
				.assignCategory("Suite C");

	}

	@Test@Parameters({"fbusername","fbpassword"})
	public void testPostComments(String fbusername,String fbpassword) throws Exception {
