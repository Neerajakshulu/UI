...
public class AppreciateUnAppreciateOthersPost extends TestBase{
	...
	public void beforeTest() throws Exception {
		...
		test = extent.startTest(var, "Verify that user is able to Appreciate/Un Appreciate their others post")
