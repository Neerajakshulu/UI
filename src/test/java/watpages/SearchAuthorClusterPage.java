...
public class SearchAuthorClusterPage extends TestBase {
	 ...
	 * @throws Exception
	 */
	public void SearchAuthorClusterLastName(String LastName, String country, String org, ExtentTest test)
			throws Exception {
		try {
			...
			if (ele.size() != 0) {
				...
				if (orgName.size() != 0) {
					...
					test.log(LogStatus.INFO,
							"Org name selection is not required as the searched user has only one org. ");
				}
			} else {
				test.log(LogStatus.INFO,
	 ...
	 * @throws Exception
	 */
	public void SearchAuthorClusterUsingLastnameAndCountry(String LastName, String country, ExtentTest test)
			throws Exception {
		try {
			pf.getBrowserActionInstance(ob).click(OnePObjectMap.WAT_AUTHOR_LASTNAME_XPATH);
			enterAuthorLastName(LastName, test);
	 ...
	 * 
	 */
	public void SearchAuthorClusterLastName(String LastName, String Country1, String Country2, String org1, String org2,
	...
	public void testFindButtonFunctionality2(String LastName,ExtentTest test) throws Exception, InterruptedException {
		...
		Assert.assertEquals(
				pf.getBrowserActionInstance(ob)
						.getElement(OnePObjectMap.WAT_AUTHOR_SEARCH_DRILL_DOWN_SUGGESTION_TEXT_XPATH).getText(),
				Suggestion_text, "AUTHOR SEARCH DRILL DOWN SUGGESTION TEXT IS NOT MATCHING");
		...
		if (ele.size() != 0) {
			...
			throw new Exception("Unable to click Find button when no country option is clicked");
	}
	 ...
	 * 
	 * @throws @author UC225218
	 * @param LastName FirstName
	 * @throws Exception
	 */
	public void SearchAuthorClusterLastAndFirstName(String LastName, String FirstName, String Country1, String Country2,
			String org1, String org2, ExtentTest test) throws Exception {
		try {
			pf.getBrowserActionInstance(ob).click(OnePObjectMap.WAT_AUTHOR_LASTNAME_XPATH);
			enterAuthorLastName(LastName, test);
	...
	/**
	 * Common method to search for an author cluster with LastName and FirstName
	 * using one country and one org
	 * 
	 * @throws @author UC202376
	 * @param LastName FirstName
	 * @throws Exception
	 */
	public void SearchAuthorClusterLastAndFirstName(String lastName, String firstName, String country, String org,
			ExtentTest test) throws Exception {
		try {
			pf.getBrowserActionInstance(ob).click(OnePObjectMap.WAT_AUTHOR_LASTNAME_XPATH);
			enterAuthorLastName(lastName, test);
	...
	/**
	 * Method to enter the author search name (Last name) character by character.
	 * 
	 * @throws Exception
	 * @param Name element Typeahead
	 * 
	 */
	...
	/**
	 * Method to enter the author search name (Last name) character by character.
	 * This method is special case for Alternate name typeahead search scenario.
	 * 
	 * @throws Exception
	 * @param Name element Typeahead
	 * 
	...
	/**
	 * Method to enter the author search name (First name) character by character.
	 * 
	 * @throws Exception
	 * @param Name
	 * 
	...
	/**
	 * Method to select value from typeahead, This will loop for 5 times incase if
	 * typeahead suggestions are not displayed.(Configurable)
	 * 
	 * @throws Exception
	 * 
	 * @param lnTypeahead selectionText
	 * 
	 */
	...
	public void testFindButtonFunctionality(String LastName, String CountryName1, String CountryName2,ExtentTest test)
		...
		if (ele.size() != 0) {
			...
			throw new Exception("Find button is not enabled when country option is clicked");
	}
	...
	public void testCountryDropdownFunctionality(String LastName,ExtentTest test) throws Exception, InterruptedException {
		...
		if (ele.size() != 0) {
			...
			throw new Exception("Country Dropdown is not disaplayed when search results are more than 50 clusters");
	}
	 ...
	 * @throws InterruptedException
	 */
	public void orgOrderTest(ExtentTest test, String LastName, String CountryName1)
			throws Exception, InterruptedException {
		try {
			...
			if (ele.size() != 0) {
				...
				pf.getBrowserWaitsInstance(ob).waitUntilElementIsDisplayed(OnePObjectMap.WAT_AUTHOR_ORG_DROPDOWN_XPATH);
				List<WebElement> OrgList = pf.getBrowserActionInstance(ob)
						.getElements(OnePObjectMap.WAT_AUTHOR_ORG_DROPDOWN_INNER_XPATH);
				...
				for (int i = 0; i < unSortedOrgname.size(); i++) {
					Assert.assertEquals(SortedOrgname.get(i), unSortedOrgname.get(i),
							"Org Names are not sorted as expected");
				}
	 ...
	 * @throws InterruptedException
	 */
	public void CountryOrderTest(ExtentTest test, String LastName, String CountryName1)
			throws Exception, InterruptedException {
		try {
			// Verify whether control is in Author Search page
			Assert.assertEquals(pf.getBrowserActionInstance(ob)
			...
			List<WebElement> ele = pf.getBrowserActionInstance(ob)
					.getElements(OnePObjectMap.WAT_AUTHOR_COUNTRY_DROPDOWN_XPATH);
			if (ele.size() != 0) {
				List<WebElement> CountryList = pf.getBrowserActionInstance(ob)
				...
				for (int i = 0; i < unSortedCountryname.size(); i++) {
					Assert.assertEquals(SortedCountryname.get(i), unSortedCountryname.get(i),
							"Country Names are not sorted as expected");
				}
	...
	/**
	 * Method to select organization value for further filtering of author cluster.
	 * 
	 * @author UC225218
	 * @throws Exception
	 * 
	...
	public void selectOrgofAuthor(ExtentTest test, String orgName) throws Exception {
		...
		// 5);
		pf.getBrowserWaitsInstance(ob).waitForElementTobeVisible(ob,
				By.xpath(OnePObjectMap.WAT_AUTHOR_ORG_DROPDOWN_XPATH.toString()), 3,
	 ...
	 * @throws Exception
	 */
	public void searchAuthorClusterLastandFirstname(String LastName, String FirstName, String CountryName1,
			String CountryName2, String OrgName1, String OrgName2, ExtentTest test) throws Exception {
		// Verify whether control is in Author Search page
		Assert.assertEquals(
		...
		test.log(LogStatus.INFO, "Entering author name... ");
		pf.getSearchAuthClusterPage(ob).SearchAuthorClusterLastAndFirstName(LastName, FirstName, CountryName1,
				CountryName2, OrgName1, OrgName2, test);
	 ...
	 * @throws Exception
	 */
	public void searchAuthorClusterOnlyLastName(String LastName, String CountryName1, String CountryName2,
			String OrgName1, String OrgName2, ExtentTest test) throws Exception {
		pf.getSearchAuthClusterPage(ob).SearchAuthorClusterLastName(LastName, CountryName1, CountryName2, OrgName1,
				OrgName2, test);
		test.log(LogStatus.PASS,
				"Successfully searched for an author using only Last name and landed in Author search result page.");
	}
	...
	public void searchAuthorClusterLessthan50DIAS(String LastName, String FirstName, String CountryName1,
			String CountryName2, String OrgName1, String OrgName2, ExtentTest test) throws Exception {
		// Verify whether control is in Author Search page
		Assert.assertEquals(
				pf.getBrowserActionInstance(ob).getElement(OnePObjectMap.WAT_WOS_AUTHOR_SEARCH_TITLE_XPATH).getText(),
		...
		test.log(LogStatus.INFO, "Entering author name... ");
		pf.getSearchAuthClusterPage(ob).SearchAuthorClusterLastAndFirstName(LastName, FirstName, CountryName1,
				CountryName1, OrgName1, OrgName2, test);
		test.log(LogStatus.PASS,
	...
	/**
	 * Method for Baloon Popover display and close using double click on popover
	 * link
	 * 
	 * @param test
	 * @throws Exception
	...
	public void ballonPopoverOpenAndClose() throws Exception {
		...
		pf.getBrowserWaitsInstance(ob)
				.waitUntilElementIsDisplayed(OnePObjectMap.WAT_AUTHOR_SEARCH_POPOVER_POPUP_FADE_IN_CSS);
		pf.getBrowserWaitsInstance(ob)
				.waitUntilElementIsClickable(OnePObjectMap.WAT_AUTHOR_SEARCH_POPOVER_POPUP_CLOSE_CSS);
		pf.getBrowserActionInstance(ob).click(OnePObjectMap.WAT_AUTHOR_SEARCH_POPOVER_POPUP_CSS);
		pf.getBrowserWaitsInstance(ob)
				.waitUntilElementIsNotDisplayed(OnePObjectMap.WAT_AUTHOR_SEARCH_POPOVER_POPUP_CLOSE_CSS);
	...
	public void ballonPopoverContent(String header, String content) throws Exception {
		...
		pf.getBrowserWaitsInstance(ob)
				.waitUntilElementIsDisplayed(OnePObjectMap.WAT_AUTHOR_SEARCH_POPOVER_POPUP_FADE_IN_CSS);
		String popover_Header = pf.getBrowserActionInstance(ob)
				.getElement(OnePObjectMap.WAT_AUTHOR_SEARCH_POPOVER_POPUP_CSS).getAttribute("wui-popover-header");
		logger.info("Popover_Header-->" + popover_Header);
		String popover_Content = pf.getBrowserActionInstance(ob)
				.getElement(OnePObjectMap.WAT_AUTHOR_SEARCH_POPOVER_POPUP_CSS).getAttribute("wui-popover-content");
