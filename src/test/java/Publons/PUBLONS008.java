...
public class PUBLONS008 extends TestBase {
	...
	public void testcaseA1() throws Exception {
		...
		try {
			...
			waitUntilText("Please enter your last name.");
			String emailErrorMessage = ob
					.findElements(By.cssSelector(OnePObjectMap.LOGING_PAGE_ERROR_MESSAGE_CSS.toString())).get(2)
					.getText();
			Assert.assertTrue(emailErrorMessage.contains("Please enter your last name."));
