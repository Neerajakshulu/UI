...
public class PUBLONS026 extends TestBase{
					...
					try{
					   ...
					   // Verify Linking model.
						...
						String useremail=
						 ...
						 pf.getPubPage(ob).linkAccount(LOGIN.getProperty("PUBLONSGMAILSTEAMPWD"));
						 pf.getPubPage(ob).verifyLinkedAccounts(LOGIN.getProperty("PUBLONSGMAILUSER"),2,test);
