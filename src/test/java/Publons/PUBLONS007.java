...
public class PUBLONS007 extends TestBase {
	static int status = 1;
	...
	public void testcaseA7() throws Exception {
		...
		try {
			...
			waitUntilText("Please enter your first name.");
			test.log(LogStatus.PASS, "Enter your first name");
			String firstnameErrorMessage = ob
					.findElements(By.cssSelector(OnePObjectMap.LOGING_PAGE_ERROR_MESSAGE_CSS.toString())).get(1)
					.getText();

			test.log(LogStatus.PASS, firstnameErrorMessage);
