...
public class DRA004 extends TestBase {
	...
	public void testcaseDRA4() throws Exception {
		...
		try {
			String statuCode = deleteUserAccounts(LOGIN.getProperty("DRAfbuser3"));
		...
		try {
			...
			ob.navigate().to(host);
			pf.getLoginTRInstance(ob).loginWithFBCredentials(LOGIN.getProperty("DRAfbuser3"),
					LOGIN.getProperty("DRAfbpw3"));
			...
			try {
				...
				pf.getLoginTRInstance(ob).enterTRCredentials(LOGIN.getProperty("DRASteamuser3"),
