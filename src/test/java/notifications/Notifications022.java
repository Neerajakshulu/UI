...
public class Notifications022 extends NotificationsTestBase {
	...
	public void beforeTest() throws Exception {
		...
		test = extent.startTest(var, "Verify that system is able to recommend six people for user").assignCategory(
				"Notifications");
				...
				test.log(
						...
						"Snapshot below: "
								+ test.addScreenCapture(captureScreenshot(this.getClass().getSimpleName()
										+ "_6_people_suggesstions_not_getting_displayed")));// screenshot
			}
