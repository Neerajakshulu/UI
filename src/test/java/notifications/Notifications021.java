...
public class Notifications021 extends NotificationsTestBase {
	...
	public void testcaseF21() throws Exception {
		...
		try {
			...
			String post_url = ob.findElement(
					By.cssSelector(OnePObjectMap.HOME_PROJECT_NEON_PROFILE_POST_TITLE_CSS.toString())).getAttribute(
					"href");
			Thread.sleep(2000);
			...
			try {
				Assert.assertTrue(text.contains("New comments") && /*
						...
						&& text.contains(fn1 + " " + ln1) && text.contains("TestCase_F21:comment"));
