...
public class Notifications002 extends NotificationsTestBase {
	...
	public void testcaseF2() throws Exception {
		...
		try {
			 ...
			 * "_user_not_receiving_notification")));// screenshot closeBrowser(); return; }
			 */
			String text = ob.findElement(By.xpath(OR.getProperty("notificationCommentEvent"))).getText();
			System.out.println(text);
			try {
				Assert.assertTrue(
				/* text.contains("TODAY") && */text.contains(fn1 + " " + ln1) && text.contains("commented on")
