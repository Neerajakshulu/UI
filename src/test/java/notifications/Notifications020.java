...
public class Notifications020 extends NotificationsTestBase {
		...
		try {
			...
			try {
				Assert.assertTrue(text.contains("New comments") && /*
																	 * text.contains("TODAY") &&
																	 */text.contains(post_title)
						&& text.contains(fn1 + " " + ln1) && text.contains("TestCase_F20:comment"));
