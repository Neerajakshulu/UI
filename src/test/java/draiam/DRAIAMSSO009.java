...
public class DRAIAMSSO009 extends TestBase {
	...
	/**
	 * //Verify Error message when Email is not released in saml attributes in saml response.
	 * @throws Exception 
	 */
  @Test
  public void testcaseDRASSO9() throws Exception {
	  boolean testRunmode = getTestRunMode(rowData.getTestcaseRunmode());
		...
		String actualErroeMsg="The page you are looking for cannot be found.";
    ...
    try {
			...
			pf.getDraSSOPageInstance(ob).loginDRAApp(LOGIN.getProperty("DRASSOSUBFLW009"),LOGIN.getProperty("DRASSOPASSWORD"));
			//Verify Error message when Email is not released in saml attributes in saml response.
			try{
