...
public class TestCase_E5 extends TestBase {
	...
	public void unWatchArticleSearchScreen(String userName, String password) throws Exception {
		...
		try {
			...
			String recordViewTitle = BrowserAction.getElement(OnePObjectMap.HOME_PROJECT_NEON_RECORD_VIEW_TITLE_CSS)
					.getText();
			...
			String articleWatchLabel = BrowserAction
					.getElement(OnePObjectMap.HOME_PROJECT_NEON_RECORD_VIEW_ARTICLE_WATCH_CSS).getText();
