...
public class TestCase_E8 extends TestBase {
	...
	public void beforeTest() throws Exception {
		...
		test = extent
				.startTest(var,
						"Verify that user is able to unwatch an Article from Article content search results page")
	...
	public void testUnwatchArticleFromArticleContentSearchResult(String articleName) throws Exception {
