...
public class WatchlistMoreButtonBelowTenArticlesTest extends TestBase{
	static int status=1;
...
//      3--->SKIP
	...
	public void unWatchArticleSearchScreen(String userName,String password) throws Exception{
		...
		//validate MORE button getting displayed if watchlist article count below 10
		...
		if(moreButtonStatus) {
			...
			test.log(LogStatus.INFO, "Snapshot below: " + test.addScreenCapture(captureScreenshot(
					this.getClass().getSimpleName() + "MORE button should not display if watchlist article count <10")));
