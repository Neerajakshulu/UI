...
public class TestCase_A6 extends TestBase{
	...
	// Checking whether this test case should be skipped or not
		...
		public void beforeTest(){
			...
			test = extent.startTest(this.getClass().getSimpleName(), "To verify LAST NAME field in new TR user registration page").assignCategory("Suite A");
