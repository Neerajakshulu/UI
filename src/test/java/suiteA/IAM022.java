...
public class IAM022 extends TestBase {
	...
	public void beforeTest() throws Exception{ extent = ExtentManager.getReporter(filePath);
		...
		test = extent.startTest(var, "Verify the checkbox for \"Receive email notifications for likes,comments and other activity\" is working correctly").assignCategory("IAM");
