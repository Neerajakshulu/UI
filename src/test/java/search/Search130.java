...
public class Search130 extends TestBase {
    ...
    public void test(String url, String recordType) throws Exception {
           ...
           try {
                  ...
                  test.log(LogStatus.INFO, this.getClass().getSimpleName()
                               + "  deeplinking execution starts for data set #" + (count + 1) + "--->");
	...
	{ 
		waitForAllElementsToBePresent(driver, By.cssSelector(OnePObjectMap.SEARCH_RESULTS_PAGE_ITEM_CSS.toString()), 180);
		List<WebElement> itemList = driver.findElements(By.cssSelector(OnePObjectMap.SEARCH_RESULTS_PAGE_ITEM_CSS.toString()));
		if(itemList.size()>0)
		return true;
		else
			return false;
