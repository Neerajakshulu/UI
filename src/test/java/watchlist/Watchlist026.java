...
public class Watchlist026 extends TestBase {
	...
	public void beforeTest() throws Exception {
		...
		test = extent.startTest(var, "Verify that same post can be added to multiple watchlists").assignCategory(
				"Watchlist");
					...
					test.log(
							...
							"Snapshot below: "
									+ test.addScreenCapture(captureScreenshot(this.getClass().getSimpleName()
											+ "_user_unable_to_add_post_into_watchlist" + i)));// screenshot
				}
			}
			// Deleting watch list
